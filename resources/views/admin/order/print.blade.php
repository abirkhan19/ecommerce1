                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p>
                                                        <strong>{{ __('Price') }} :</strong> {{$order->currency_sign}}{{ round($product['price'] * 1 , 2) }}
                                                </p>
                                               <p>
                                            ...
                                            <td>{{$order->currency_sign}}{{ round($product['price'] * 1 , 2) }}
                                            </td>
                                            @php
                                        ...
                                        @php 
                                        $price = round(($order->shipping_cost / 1),2);
                                        @endphp
                                        ...
                                        @php 
                                        $pprice = round(($order->packing_cost / 1),2);
                                        @endphp
