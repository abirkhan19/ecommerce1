    ...
    <div class="content-area">
                ...
                <td width="45%">{{$order->shipping_zip == null ? $order->customer_zip : $order->shipping_zip}}</td>
                            ...
                            <div class="row">
                                ...
                                @php $getProduct = \App\Models\Product::find($product['product_id']); @endphp
                                    <tr>
                                        
                                            <td><input type="hidden" value="{{$getProduct->id}}"{{ $product['product_id'] }}</td>
                                            ...
                                            <td>
                                                @if($product['user_id'] != 0 && $product['user_id'] !=49)
                                                @php
                                            ...
                                            <td>
                                                <input type="hidden" value="{{ $getProduct->licence }}">
                                                ...
                                                @endphp
                                                @if(isset($user))
                                              <a target="_blank" href="{{ route('product.details', $getProduct->slug) }}">{{mb_strlen($getProduct->name,'utf-8') > 30 ? mb_substr($getProduct->name,0,30,'utf-8').'...' : $getProduct->name}}</a>
                                                @else
                                                <a target="_blank" href="{{ route('product.details', $getProduct->slug) }}">{{mb_strlen($getProduct->name,'utf-8') > 30 ? mb_substr($getProduct->name,0,30,'utf-8').'...' : $getProduct->name}}</a>
                                                @endif
                                                @else 

                                                <a target="_blank" href="{{ route('product.details', $getProduct->slug) }}">{{mb_strlen($getProduct,'utf-8') > 30 ? mb_substr($getProduct->name,0,30,'utf-8').'...' : $getProduct->name}}</a>
                                            
                                                @endif


                                                @if($getProduct->licence != '')
                                            ...
                                            <td>
                                                ...
                                                <p>
                                                        <strong>{{ __('Price') }} :</strong> {{ round($product['price'], 2) }}
                                                </p>
                                               <p>
                                                    ...
                                                    @foreach( array_combine(explode(',', $product['attributes']), explode(',', $product['prices']))  as $key => $value)
                                                    <p>
